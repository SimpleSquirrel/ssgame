...
public class FirstBoss implements Screen {
    private MyGame game;
    ...
    public void render(float delta) {
        ...
        setScene(0, "Далі тебе чекає перша битва з босом.", Assets.spriteRobotInactive, Assets.spriteCatActive);
        setScene(1, "Бос?", Assets.spriteRobotActive, Assets.spriteCatInactive);
        setScene(2, "Так. Для того, щоб пройти в замок, тобі треба перемогти...\n\nВедмеДІО!!!", Assets.spriteRobotInactive, Assets.spriteCatActive);
        setScene(3, "???", Assets.spriteRobotActive, Assets.spriteCatInactive);
        setScene(4, "Неважливо. Просто піди й побий його.\n\nІ так, ми не можемо піти з тобою. Хай щастить.", Assets.spriteRobotInactive, Assets.spriteCatActive);
        setScene(5, "Я ненавиджу цього кота.", Assets.spriteRobotActive, Assets.spriteCatInactive);
        game.batch.end();
    }
