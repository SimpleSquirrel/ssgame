...
public class ArmoredBiter extends Enemy {
    ...
    public ArmoredBiter(World world, float x, float y, boolean flip){
        ...
        atlas = new TextureAtlas("Enemies/ArmoredBiter.txt");
        spriteBiter1 = atlas.createSprite("ArmoredBiter1");
        spriteBiter2 = atlas.createSprite("ArmoredBiter2");
        spriteBiter3 = atlas.createSprite("ArmoredBiter3");
        spriteBiter4 = atlas.createSprite("ArmoredBiter4");
        spriteBiter01 = atlas.createSprite("ArmoredBiter1");
        spriteBiter02 = atlas.createSprite("ArmoredBiter2");
        spriteBiter03 = atlas.createSprite("ArmoredBiter3");
        spriteBiter04 = atlas.createSprite("ArmoredBiter4");
    ...
    public Sprite spriteArmoredBiter(float delta){
        Sprite sprite;
        timer+=delta;
