...
public class GameScreenLevel7 implements Screen {
    private MyGame game;
...
private Labels labels;
    ...
    private Cactus cactus6;
    private Cactus cactus7;
    private Cactus cactus8;
    private Cactus cactus9;
    private Portal portal;
    private Chest chest;
    public static float destroyTimer;
    private Sound bgmusic = Gdx.audio.newSound(Gdx.files.internal("Music/03ChibiNinja.mp3"));

    public GameScreenLevel7(MyGame game){
        this.game = game;
        bgmusic.loop(0.05f);
labels=new Labels(game);
        ...
        map = mapLoader.load("Level2Loc2.tmx");
        ...
        biter = new Biter(world, 32*29/PPM, 32/PPM, false);
        biters.add(biter);
        biter1 = new Biter(world, 32*47/PPM, 32/PPM, false);
        biters.add(biter1);
        biter2 = new Biter(world, 32*45/PPM, 32/PPM, false);
        biters.add(biter2);
        biter3 = new Biter(world, 32*43/PPM, 32/PPM, false);
        biters.add(biter3);
        biter4 = new Biter(world, 32*41/PPM, 32/PPM, false);
        biters.add(biter4);
        biter5 = new Biter(world, 32*39/PPM, 32/PPM, false);
        biters.add(biter5);
        biter6 = new Biter(world, 32*37/PPM, 32/PPM, false);
        biters.add(biter6);
        biter7 = new Biter(world, 32*35/PPM, 32/PPM, false);
        biters.add(biter7);
        biter8 = new Biter(world, 32*33/PPM, 32/PPM, false);
        biters.add(biter8);
        biter9 = new Biter(world, 32*31/PPM, 32/PPM, false);
        biters.add(biter9);
        biter10 = new Biter(world, 32*27/PPM, 32/PPM, false);
        biters.add(biter10);
        biter11 = new Biter(world, 32*25/PPM, 32/PPM, false);
        biters.add(biter11);
        biter12 = new Biter(world, 32*23/PPM, 32/PPM, false);
        biters.add(biter12);
        cactus = new Cactus(world, 32*14/PPM, 32*12/PPM, false);
        cactuses.add(cactus);
        cactus1 = new Cactus(world, 32*16/PPM, 32*12/PPM, false);
        cactuses.add(cactus1);
        cactus2 = new Cactus(world, 32*18/PPM, 32*12/PPM, false);
        cactuses.add(cactus2);
        cactus3 = new Cactus(world, 32*20/PPM, 32*12/PPM, false);
        cactuses.add(cactus3);
        cactus4 = new Cactus(world, 32*22/PPM, 32*12/PPM, false);
        cactuses.add(cactus4);
        cactus5 = new Cactus(world, 32*24/PPM, 32*12/PPM, false);
        cactuses.add(cactus5);
        cactus6 = new Cactus(world, 32*26/PPM, 32*12/PPM, false);
        cactuses.add(cactus6);
        cactus7 = new Cactus(world, 32*28/PPM, 32*12/PPM, false);
        cactuses.add(cactus7);
        cactus8 = new Cactus(world, 32*30/PPM, 32*12/PPM, false);
        cactuses.add(cactus8);
        cactus9 = new Cactus(world, 32*32/PPM, 32*12/PPM, false);
        cactuses.add(cactus9);
        portal = new Portal(world, 32*12/PPM, 32/PPM, -20/PPM, 29/PPM, false);
        chest = new Chest(world, 32*39/PPM, 32*12/PPM, 0, 16/PPM, false, game, game.preferences.getBoolean("IronChest2IsOpened"));
    ...
    public void update(float dt) {
        ...
        if(chest.thisChestIsTouched()){
            game.preferences.putBoolean("IronChest2IsOpened", true);
            game.preferences.flush();
        }
        player.update(dt);
        familiar.update(dt);
